          ...
          <div className="flex row relative justify-center gap-20 ">
            <div className="p-2 flex flex-col items-center relative group cursor-pointer  ">
              <img
                ...
                className="m-2 min-h-[200px] cursor-pointer border-2 p-1 border-gray-600    shadow-md  max-w-[200px]    object-contain  transition duration-300 ease-in-out group-hover:filter group-hover:brightness-75   "
              />
            ...
            <div className=" flex flex-col items-center relative group cursor-pointer p-2  ">
              <img
                ...
                className="m-2 min-h-[200px] cursor-pointer  max-w-[200px]  border-2  border-gray-600  object-contain  transition duration-300 ease-in-out group-hover:filter group-hover:brightness-75 "
              />
                ...
                {images?.data?.images?.map((image) => (
                  ...
                  >
                    <img
                      ...
                      className="m-2 min-h-[200px] cursor-pointer  max-w-[200px] border-2 p-1 border-gray-600   object-contain  transition duration-300 ease-in-out group-hover:filter group-hover:brightness-75    " 
                    />
                    {/* <img
                     src={Pin}
                     alt="Pin"
