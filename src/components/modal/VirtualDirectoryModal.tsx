...
const VirtualDirectoryModal: FC<UploadFileModalProps> = ({openModel, setOpen, imgData, onDeleteHandler, isSuccess} ) : JSX.Element => {
...
export default VirtualDirectoryModal
